...
export default function Hero() {
  return (
    <section className="min-h-screen pt-24 pb-16 px-6">
      ...
      >
        <Github className="w-12 h-12 text-black hover:text-blue-600 transition-all duration-300" />
      </motion.a>
      <motion.a
        ...
        whileHover={{ scale: 1.2 }}
      >
        <Linkedin className="w-12 h-12 text-blue-500 hover:text-purple-600 transition-all duration-300" />
      </motion.a>
    </div>
          <motion.p
